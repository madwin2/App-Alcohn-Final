/** Preset Alcohn: logos negros sobre fondo blanco, sin fondo en la salida.
 *  Fuente de verdad del servidor. El cliente solo puede mandar overrides de allowlist.
 */
export const ALCOHN_PRESET = {
