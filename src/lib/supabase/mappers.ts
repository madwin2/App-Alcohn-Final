...
export const mapOrdenToOrder = (
  ...
  return {
    ...
    labelState: (orden as { etiqueta_estado?: Order['labelState'] }).etiqueta_estado ?? null,
    labelErrorCode: (orden as { etiqueta_error_codigo?: string | null }).etiqueta_error_codigo ?? null,
    labelErrorMessage: (orden as { etiqueta_error_mensaje?: string | null }).etiqueta_error_mensaje ?? null,
    labelGeneratedAt: (orden as { etiqueta_generada_at?: string | null }).etiqueta_generada_at ?? null,
