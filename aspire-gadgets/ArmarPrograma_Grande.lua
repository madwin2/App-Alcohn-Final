-- VECTRIC LUA SCRIPT
-- Armar Programa - Maquina Grande (G)
--
...
-- (AUTOMATIZACION_SIMPLIFICADA GRANDE.lua para Clasico, o la variante _3MM
-- GRANDE para 3mm).
--
...
--   automatizacion de esta maquina (los que estan en "lua/MAQUINA GRANDE/") y
--   la recuerda para la proxima (no lo vuelve a preguntar).
--
-- Uso normal:
...
local CLASICO_FILE = "AUTOMATIZACION_SIMPLIFICADA GRANDE.lua"
local TIPO3MM_FILE = "AUTOMATIZACION_SIMPLIFICADA_3MM GRANDE.lua"
