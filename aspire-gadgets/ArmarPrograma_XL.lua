...
-- (AUTOMATIZACION_SIMPLIFICADA XL.lua para Clasico, o la variante _3MM XL
-- para 3mm).
--
...
--   automatizacion de esta maquina (los que estan en "lua/MAQUINA XL/") y la
...
local CLASICO_FILE = "AUTOMATIZACION_SIMPLIFICADA XL.lua"
-- OJO: el archivo real en disco tiene DOS espacios antes de "XL" -- no es un
-- error de tipeo, hay que respetarlo tal cual para que dofile lo encuentre.
local TIPO3MM_FILE = "AUTOMATIZACION_SIMPLIFICADA_3MM  XL.lua"
